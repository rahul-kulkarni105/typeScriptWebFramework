...
function () {
  ...
  View.prototype.render = function () {
    // clean the previous dom, replacing with empty string.
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // 1st Way of adding getters
    // get on() {
...
exports.Attributes = Attributes; // To explain <K extends keyof T> (key: K): T[K]
